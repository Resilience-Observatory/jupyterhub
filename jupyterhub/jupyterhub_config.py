...
#c.JupyterHub.bind_url = 'http://%s:8000' % os.environ['HOST']
...
c.DockerSpawner.volumes = { '/home/shared': notebook_dir+'/shared', '/media/flash': notebook_dir+'/shared/flash', '/etc/group': '/etc/group', '/etc/sudoers': '/etc/sudoers' }
...
c.Authenticator.admin_users = { 'pzz', 'cgm' }
